...
> **Estado (2026-09-25):** sin empezar. Va después de la declaración de cumplimiento de factura (#48).
...
- [ ] Declaración de cumplimiento de factura firmada (#48).
- [ ] Ver en maullín cómo se postula a boleta y pedir el set (crea algo en el SII: confirmación explícita).
...
- [ ] `set_pruebas.py` lee el set de boletas (tipos 39 y 41, montos IVA incluido).
...
- [ ] Visto bueno del SII y declaración de cumplimiento de la representante.
